...
Toggle.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: Toggle, selectors: [["ibm-toggle"]], hostVars: 2, hostBindings: function Toggle_HostBindings(rf, ctx) { if (rf & 2) {
        ...
        ]), ɵngcc0.ɵɵInheritDefinitionFeature], decls: 10, vars: 23, consts: [["class", "bx--label", 3, "id", "ngClass", 4, "ngIf"], ["type", "checkbox", 1, "bx--toggle-input", 3, "ngClass", "id", "value", "name", "required", "checked", "disabled", "change", "click"], [1, "bx--toggle-input__label", 3, "for", "ngClass"], [1, "bx--toggle__switch"], [1, "bx--toggle__text--off"], [1, "bx--toggle__text--on"], [1, "bx--label", 3, "id", "ngClass"], [4, "ngIf"], [3, "ngTemplateOutlet"]], template: function Toggle_Template(rf, ctx) { if (rf & 1) {
