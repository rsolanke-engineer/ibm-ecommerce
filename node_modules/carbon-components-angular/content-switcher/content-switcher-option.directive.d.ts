...
export declare class ContentSwitcherOption implements OnInit {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<ContentSwitcherOption, "[ibmContentOption]", never, { "name": "name"; "active": "active"; }, { "selected": "selected"; "onClick": "onClick"; "onFocus": "onFocus"; }, never, never, false>;
}
