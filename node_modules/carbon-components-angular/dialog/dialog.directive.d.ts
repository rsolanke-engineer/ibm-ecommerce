...
export declare class DialogDirective implements OnInit, OnDestroy, OnChanges {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<DialogDirective, "[ibmDialog]", ["ibmDialog"], { "title": "title"; "trigger": "trigger"; "closeTrigger": "closeTrigger"; "placement": "placement"; "gap": "gap"; "appendInline": "appendInline"; "data": "data"; "isOpen": "isOpen"; "disabled": "disabled"; "ibmDialog": "ibmDialog"; "offset": "offset"; "wrapperClass": "wrapperClass"; "shouldClose": "shouldClose"; }, { "onClose": "onClose"; "onOpen": "onOpen"; "isOpenChange": "isOpenChange"; }, never, never, false>;
}
