...
export declare class AbstractDropdownView {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<AbstractDropdownView, "[ibmAbstractDropdownView]", never, { "items": "items"; }, { "select": "select"; "blurIntent": "blurIntent"; }, never, never, false>;
}
