...
export declare class DropdownList implements AbstractDropdownView, AfterViewInit, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<DropdownList, "ibm-dropdown-list", never, { "ariaLabel": "ariaLabel"; "listTpl": "listTpl"; "type": "type"; "showTitles": "showTitles"; "items": "items"; }, { "select": "select"; "scroll": "scroll"; "blurIntent": "blurIntent"; }, never, never, false>;
}
